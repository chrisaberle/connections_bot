...
def prune_historic_data():
    ...
    historic_data = pd.read_csv('./volumes/data/historic_scores.csv')
    ...
    historic_data_pruned.to_csv('./volumes/data/historic_scores.csv', index=False)
...
async def process_all_messages(messages):
    ...
    historic_scores_df = pd.read_csv('./volumes/data/historic_scores.csv')
    ...
    all_data_df.to_csv('./volumes/data/historic_scores.csv', index=False)
...
async def update_users():
    ...
    users_df.to_csv('./volumes/data/users.csv', index=False)
...
async def generate_leaderboard_message():
    ...
    # Load user names
    users = pd.read_csv('./volumes/data/users.csv')
